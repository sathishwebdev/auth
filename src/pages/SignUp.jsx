...
function SignUp() {
  ...
  }, [user_login, dispatch, loading, error, success, navigate]);
  ...
  return (
    <div className="App-header" style={{ borderRadius:"0 0 0 0", minHeight:"100vh"}}>
            <div className=' pad col-12 col-sm-6 text-center' >
                ...
                />
                <br/>
                      <small style={{color:"red"}} >{errors.conformPassword && touched.conformPassword && errors.conformPassword}</small>
                      <br/>
                <PrimaryButton
                  type="submit"
